            ...
            <table class="table table-borderless container mt-5" >
                ...
                <tbody>
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="invoice" value="INV{{ sprintf("%07d", $prdid) }}{{ $jmlpesan+1 }}{{ auth()->user()->id }}">
                    ...
                    <tr class="align-middle">
                        ...
                        <td style="width: 100px">
                                ...
                                <img src="{{ asset('storage/'.Str::remove('public/', $psn->images1)) }}" alt="..." class="img-thumbnail me-3" style="width: inherit;">
        ...
        <div class="payment-method container py-5">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="mbayar_id" id="mbayar_id" value="{{$rbb->id}}"
                        required>
            ...
            <table class="totalan">
                ...
                {{-- <tr>
                    ...
                    <td class="jml" id="ongkir">Rp.10.000</td>
                </tr> --}}
                <tr>
