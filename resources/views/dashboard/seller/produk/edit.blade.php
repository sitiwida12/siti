...
@section('contents')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form method="POST" action="/dashboard/produk/{{ $produk->id }}" class="d-block w-100" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="judul_produk" placeholder="Judul Produk" value="{{ $produk->judul_produk }}"> 
                ...
                <div class="row my-3">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="harga" class="form-control" name="harga" placeholder="Harga" class="w-100" value="{{ $produk->harga }}">
                        </div>
                    </div>
                    <div class="col">
